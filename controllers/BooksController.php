...
class BooksController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        $arLanguages = Languages::find()->select('name')->indexBy('id')->column();
    ...
    public function actionAddAuthor($idBook)
    {
        ...
        $arCurrentAuthor = BooksAuthors::find()->select('id_author')->where(['id_book' => $idBook])->column();
    ...
    public function actionRemoveAuthor($idBook)
    {
        $modelBook = $this->findModel($idBook);
        $dataProvider = new ActiveDataProvider([
            'query' => BooksAuthors::find()->innerJoinWith(BooksAuthors::RELATION_AUTHOR)->where(['id_book' => $idBook]),
            'pagination' => [
                'pageSize' => Yii::$app->params['paginationSize'],
            ],
        ]);
